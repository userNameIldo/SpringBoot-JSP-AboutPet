...
/* 	str = f.productNum.value;
	...
	f.action = "<%=cp%>/insertProduct_ok.action";
	f.submit();
...
<!-- 제품번호:<input  type="text" name="productNum"><br> -->
...
<!-- 강아지 소분류 -->
	...
	<option value="강아지간식" class="cate강아지">간식</option>
