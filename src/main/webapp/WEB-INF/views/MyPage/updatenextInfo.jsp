...
<link rel="stylesheet" type="text/css" href="resources/css/nextInfo2.css">
					...
					<div class="tag-choise">
						...
						<div class="filter-area t2">
							<div class="filter-item">
								<div class="tag">
									<input type="button" class="tag_btn" id="test" value="강아지"/>
									<input type="button" class="tag_btn" id="test2" value="재미"/>
