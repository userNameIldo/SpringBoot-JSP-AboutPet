...
<footer class="footer" id='footer'>
            ...
            <div class="inr">
                <div class="link">
                    <ul class="list">   
                        <li><a href="#staticBackdrop" data-bs-toggle="modal">서비스 이용약관</a></li>               
                        <li><a href="#staticBackdrop1" data-bs-toggle="modal">개인정보처리방침</a></li>
                        <li><a href="#staticBackdrop2" data-bs-toggle="modal">입점/제휴 문의</a></li>         
                    </ul>
                </div>
                ...
                <div class="info">
                    <ul class="list">
                        ...
                        <li>사업자 등록번호 : 120-87-90035 사업자정보확인</li> 
                        <li>통신판매업신고번호 : 제 2020-서울강남-03142호</li> 
                        <li>개인정보관리자 : 편윤국 it@aboutpet.co.kr</li>
                        <li>TEL : 1644-9601</li>
                    </ul>
		  ...
		  <div class="modal-dialog modal-dialog-scrollable">
		    <div class="modal-content">
		      <div class="modal-header">
				...
				이 약관은 (주)어바웃펫  회사(전자거래 사업자)가 운영하는 어바웃펫 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br/>
				※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br/>
				<br/>
				
				제2조(정의)<br/>
				
				① "몰"이란 (주)어바웃펫  회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br/>
				...
				⑧ 이 약관에서 사용하는 용어 중 본 조에서 정하지 아니한 것은 서비스 이용 시 제공되는 안내, 관계 법령에서 정하는 바에 따르며, 그 외에는 일반 관례에 따릅니다.<br/>
				<br/>
				<br/>
				<br/>
				...
				⑤ 기타 GS리테일 멤버십(THE POP) 과 관련한 내용은 GS리테일 멤버십(THE POP) 회원 약관을 준수합니다.<br/>
				<br/>
				 <br/>
				<br/>
				<br/>
				...
				⑥ 회사는 회원이 1년 동안 로그인하지 않은 경우, 휴면계정으로 분류하고 개인정보 파기 조치를 위하여 회원탈퇴 처리할 수 있습니다.<br/>
				<br/>
				<br/>
				제8조(회원에 대한 통지)<br/>
				<br/>
				...
				8. 다른 회원을 희롱 또는 위협하거나, 특정 회원에게 지속적으로 고통 또는 불편을 주는 행위<br/>
				<br/>
				<br/>
				...
				④ 회사는 회원이 서비스 내에 게시한 게시물이 관련 법령에 위반되거나 음란 또는 청소년에게 유해한 게시물, 차별 갈등을 조장하는 게시물, 도배 · 광고 · 홍보 · 스팸성 게시물, 계정을 양도 또는 거래하는 내용의 게시물, 타인을 사칭하는 게시물 등이라고 판단되는 경우 이를 삭제하거나 게시를 거부할 수 있습니다.<br/> 
				<br/>
				<br/>
				...
				<br/>
				 <br/>
				<br/>
				① 회사는 이용자의 개인정보를 “제 17조 개인정보보호정책” 에서 고지한 범위 내에서 사용하며 동 범위를 초과하여 이용하거나 원칙적으로 제 3자에게 제공하지 않습니다.<br/>
				<br/>
				다만 다음의 경우에는 합당한 절차를 통한 회원의 동의를 얻어 개인정보를 제공 또는 이용할 수 있습니다.<br/>
				<br/>
				② 회사는 보다 나은 서비스 제공을 위하여 회원의 개인정보를 제휴사에 제공할 수 있습니다. 이 경우 회원에게 개인정보의 항목, 개인정보 제공 목적, 제공기간, 개인정보보호방안 등에 대해서 사전에 개별적으로 동의를 구하는 절차를 거치게 되며, 회원의 동의가 없는 경우에 이를 제공하지 않습니다.<br/>
				<br/>
				③ 회사는 보다 나은 서비스 제공을 위하여 회원의 개인정보를 위탁하여 처리할 수 있으며, 이 경우 반드시 사전에 위탁처리 업체명과 목적, 위탁처리 되는 개인정보의 범위, 위탁기간 등에 대해 상세하게 고지합니다.<br/>
				<br/>
				④ 단, 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우에는 사전 동의 없이 제공될 수 있습니다.<br/>
				<br/><br/><br/><br/>
				제24조(분쟁해결)<br/>
				<br/>
				...
				부칙
				<br/><br/>
				1. 이 약관은 2021년 4월 30일부터 적용됩니다.<br/>
		      	</div>
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      	...
		      	<div class="modal-body">
					(주)어바웃펫은 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리방침을 수립·공개하며, 본 개인정보 처리방침을 홈페이지 첫 화면에 공개함으로써 이용자들이 언제나 용이하게 보실 수 있도록 조치하고 있습니다. 개인정보 처리방침은 정부의 법률 및 지침 변경이나 회사의 내부 방침 변경 등으로 인하여 수시로 변경될 수 있고, 이에 따른 개인정보 처리방침의 지속적인 개선을 위하여 필요한 절차를 정하고 있습니다. 이용자들께서는 사이트 방문 시 수시로 확인하시기 바랍니다.<br/> 
<br/>
<br/>
(주)어바웃펫의 개인정보 처리방침은 다음과 같은 내용을 담고 있습니다.<br/>
<br/>
1. 개인정보 수집에 대한 동의<br/>
...
<br/>
1. 개인정보 수집에 대한 동의<br/>
(주)어바웃펫은 이용자들이 회사의 개인정보수집이용 동의 또는 이용약관의 내용에 대하여 「동의」버튼 또는 「취소」버튼을 클릭할 수 있는 절차를 마련하여, 「동의」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.<br/>
<br/>
 ...
 <br/>
        ...
        <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		  <div class="modal-dialog modal-dialog-scrollable">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="staticBackdropLabel">입점/제휴 문의</h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
		      	<div class="modal-body">
				입점 및 제휴 문의는 온라인 접수를 통해서만 가능합니다.<br/>
				<br/>
				입점, 마케팅 등 파트너십 관련 문의는 아래 메일을 통해 연락주세요.<br/>
				<br/>
				1. 제휴 신청서 접수<br/>
				<br/>
				입점 및 제휴 제안서를 작성하신 후 아래 메일로 보내주세요.<br/>
				<br/>
				(신청서 제출 : md@petsbe.com)<br/>
				<br/>
				<br/>
				메일 제목은 아래와 같이 통일해주세요.<br/>
				<br/>
				(예시 : [제휴종류]입점 및 제휴 제안서_업체명)<br/>
				<br/>
				2. 제휴 신청서 검토<br/>
				<br/>
				담당자가 접수된 신청서를 검토하고 연락드립니다.<br/>
				<br/>
				3. 계약 체결 및 판매<br/>
				<br/>
				상품 진행이 확정되면 계약을 체결하고 상품 판매가 가능합니다.<br/>
		      	</div>
		      <div class="modal-footer"></div>
    		</div>
 		 </div>
